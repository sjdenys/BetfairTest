...
import com.example.sjden.betfairtest.HTTPResponseListener;
...
public class APINGLoginRequester {
    ...
    public void sendRequest(HashMap<String,String> hshmpURL, HashMap<String,String> hshmpParameters){
    ...
    private class localRequester extends AsyncTask<HashMap<String,String>, Void, String> {
        ...
        protected String doInBackground(HashMap<String,String>... params){
            return performPostCall(params[0].get("URL"), params[1]);
        }
